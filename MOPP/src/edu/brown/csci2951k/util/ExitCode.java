...
public enum ExitCode {
    ...
    NO_DATA(2, "if the configuration file data cannot be loaded."),
    CLI_ERROR(3, "if the CLI reports an error."),
    NETWORK_ERROR(4, "if the networking work reports an error.");
